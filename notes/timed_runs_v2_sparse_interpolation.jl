...
include("/GitHub/PhyBEARS.jl/notes/timed_runs_v2_sparse_interpolation.jl")
"""
...
CSV.write("tdf1a_cont_sparse.txt", tdf1, delim="\t")
...
CSV.write("tdf2a_cont_sparse.txt", tdf2, delim="\t")
...
tdf1 = indexed_Dict_to_DF(tres)
CSV.write("tdf1b_cont_sparse.txt", tdf1, delim="\t")
...
tdf2 = indexed_Dict_to_DF(tres)
CSV.write("tdf2b_cont_sparse.txt", tdf2, delim="\t")
