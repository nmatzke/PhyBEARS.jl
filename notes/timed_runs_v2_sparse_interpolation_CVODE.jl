...
"""
cd("/GitHub/PhyBEARS.jl/notes/")
include("/GitHub/PhyBEARS.jl/notes/timed_runs_v2_sparse_interpolation_CVODE.jl")
...
tdf_CVODE = indexed_Dict_to_DF(tres)
CSV.write("tdf_CVODE_cont_sparse.txt", tdf_CVODE, delim="\t")
