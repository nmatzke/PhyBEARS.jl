...
# /GitHub/PhyBEARS.jl/notes/Fezzik_precompile_packages_v1.jl

# 4. Close, reopen Julia, follow instructions to do (long) Fezzik 
#    precompile, then close/open as instructed.


# 5. In your startup.jl file, do this to load PhyBEARS:

print("Loading PhyBEARS...\n")
...
# 6. Run the example PhyBEARS functions here:
#   include("/GitHub/PhyBEARS.jl/notes/startup_basic_tests_v1.jl")
#
...
Pkg.add(PackageSpec(url="https://github.com/nmatzke/PhyBEARS.jl"))
    Cloning git-repo `https://github.com/nmatzke/PhyBEARS.jl`
...
Search ~/.julia/ on PhyBEARS and delete old version
