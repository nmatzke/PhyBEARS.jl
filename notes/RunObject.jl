...
print("\n\nLoading 'RunObject'...loading dependencies...\n")
...
#######################################################
# Goal: Set up the run object for PhyBEARS.
#######################################################
# 
...
lgdata_fn = "/GitHub/PhyBEARS.jl/ex/homs1/homs_geog.txt"
geog_df = Parsers.getranges_from_LagrangePHYLIP(lgdata_fn)

tr_bkup = readTopology("(((human:0.5):0.5,(chimp:0.5):0.5):1.0,(gorilla:1.5):0.5);")
trfn = "/GitHub/PhyBEARS.jl/ex/homs1/homs_w_breakpoint.newick"
...
"""
include("/GitHub/PhyBEARS.jl/notes/RunObject.jl")
import .RunObject
