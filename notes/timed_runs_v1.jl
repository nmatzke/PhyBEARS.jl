...
include("/GitHub/PhyBEARS.jl/notes/timed_runs_v1.jl")
"""
...
timed_run_goldstandard(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3)
timed_run_goldstandard_parallel(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3)
timed_run_Gflow_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3)
timed_run_trad_solverFree(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3)
timed_run_trad_solverFree_parallel(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3)
timed_run_Gflow_solverFree(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3)
timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3, Gseg_times=NaN)
timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3, Gseg_times=NaN)
...
i+=1; tres[i]=timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-9, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-12, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-15, Gseg_times=NaN)

i+=1; tres[i]=timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-3, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-9, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-12, Gseg_times=NaN)
i+=1; tres[i]=timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-15, Gseg_times=NaN)
...
function timed_run_goldstandard(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6)
	...
	sol_Es_v5 = solve(prob_Es_v5, solver_options.solver, save_at=[], save_everystep=solver_options.save_everystep, abstol=solver_options.abstol, reltol=solver_options.reltol, dense=true);
	push!(calctimes, (Dates.now() - tmpt).value/1000.0);
...
function timed_run_trad_solverFree(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6)
	...
	# The Es solver must be continuous!
	prob_Es_v5 = DifferentialEquations.ODEProblem(parameterized_ClaSSE_Es_v5, p_Ds_v5.uE, Es_tspan, p_Ds_v5);
	sol_Es_v5 = solve(prob_Es_v5, solver_options.solver, save_at=[], save_everystep=true, abstol=solver_options.abstol, reltol=solver_options.reltol, dense=true);
	push!(calctimes, (Dates.now() - tmpt).value/1000.0);
...
# User sets the error tolerance
#######################################################
function timed_run_Gflow_CVODE_solverFree(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6)
	tr = readTopology(trfn)
	geog_df = Parsers.getranges_from_LagrangePHYLIP(geogfn)
...
function timed_run_Gflow_solverFree(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6)
	...
	tmpt = Dates.now()
	prob_Es_v5 = DifferentialEquations.ODEProblem(parameterized_ClaSSE_Es_v5, p_Ds_v5.uE, Es_tspan, p_Ds_v5);
	sol_Es_v5 = solve(prob_Es_v5, save_at=[], save_everystep=true, abstol=solver_options.abstol, reltol=solver_options.reltol, dense=true);
	push!(calctimes, (Dates.now() - tmpt).value/1000.0);
...
# User sets the error tolerance
#######################################################
function timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6, Gseg_times=NaN)
	tr = readTopology(trfn)
	geog_df = Parsers.getranges_from_LagrangePHYLIP(geogfn)
	...
	if isnan(Gseg_times) == true
		Gseg_times = seq(0.0, root_age*1.01, (root_age*1.01)/10);
	end
...
# User sets the error tolerance
#######################################################
function timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-6, Gseg_times=NaN)
	tr = readTopology(trfn)
	geog_df = Parsers.getranges_from_LagrangePHYLIP(geogfn)
