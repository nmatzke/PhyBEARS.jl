...
#i+=1; tres[i]=timed_run_GflowArrays_CVODE(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-17, Gseg_times=NaN, num_incs=100) # too much accuracy requested
...
#i+=1; tres[i]=timed_run_GflowArrays_CVODE_dbl(trfn, geogfn; bmo=NaN, include_null_range=false, tol=1e-17, Gseg_times=NaN, num_incs=100) # too much accuracy requested

tdf3a = indexed_Dict_to_DF(tres)
df_to_Rdata(tdf3a; fn="tdf3a_cont_smooth.RData")
