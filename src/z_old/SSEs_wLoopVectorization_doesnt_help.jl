...
parameterized_ClaSSE_Ds_v8_simd_sums = (du,u,p,t) -> begin
...
function sum_Cijk_rates_Ds_tturbo(Cijk_rates_sub_i, tmp_u, tmp_uE, Cj_sub_i, Ck_sub_i)
    term1 = 0.0
    term4 = 0.0
...
function sum_Cijk_rates_Es_tturbo(Cijk_rates_sub_i, tmp_u, Cj_sub_i, Ck_sub_i)
    term1 = 0.0
    term4 = 0.0
   	@tturbo for it=1:length(Cijk_rates_sub_i)
    	term1 += Cijk_rates_sub_i[it]
...
function sum_Qij_vals_tturbo(Qij_vals_sub_i, tmp_u, Qj_sub_i)
    term2 = 0.0
    term3 = 0.0
