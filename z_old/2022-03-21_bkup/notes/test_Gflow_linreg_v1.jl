...
# Run with:
cd("/GitHub/BioGeoJulia.jl/notes/")
include("/GitHub/BioGeoJulia.jl/notes/test_Gflow_linreg_v1.jl")
"""
# 
# """
# # Run with:
...
#Pkg.add("CSV")
using CSV
CSV.write("res_table_df_Ci_eq_i_GflowMap_v9.txt", res_table_df; delim="\t")
