...
# Hi all,
# 
# I'm a new user of BioGeoBEARS and I'm just trying to get the sample script running.  I'm hoping the following is a simple issue....  
# 
...
# 
#  Error in .C("node_height", as.integer(Ntip), as.integer(Nnode), as.integer(edge[,  : 
#   Incorrect number of arguments (6), expecting 4 for 'node_height' 
# 6.
# .nodeHeight(Ntip, Nnode, z$edge, Nedge, yy) at plot_phylo3_nodecoords.R#156
# 5.
# plot_phylo3_nodecoords(tr, plot = FALSE, root.edge = root.edge) at <text>#1
# 4.
# eval(parse(text = cmdstr)) 
# 3.
# eval(parse(text = cmdstr)) at BioGeoBEARS_plots_v1.R#1871
# 2.
# node_coords(tr, tmplocation = cornercoords_loc, root.edge = root.edge) at BioGeoBEARS_plots_v1.R#457
# 1.
...
# Trying to access par without opening #(@#)* plot!
