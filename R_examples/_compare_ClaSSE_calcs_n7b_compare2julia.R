...
classe_params[grepl(pattern="mu", x=param_names)][1] = 0.1
classe_params[grepl(pattern="mu", x=param_names)][2] = 0.5
classe_params[grepl(pattern="mu", x=param_names)][3] = 1.0
...
lq
sum(lq)
# -0.7520391 -0.3839259 -1.372728    0 -2.586412
# -5.095105
