...
"""
# Run with:
cd("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj+BD_M0_mr3/")
include("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj+BD_M0_mr3/phybears_M0_mr3_DEC+J_BD_v2.jl")
"""

setwd("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj+BD_M0_mr3/")

# Input geography
lgdata_fn = "/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj+BD_M0_mr3/geog.data"
geog_df = Parsers.getranges_from_LagrangePHYLIP(lgdata_fn)

# Input tree
trfn = "/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj+BD_M0_mr3/tree.newick"
...
library(diversitree)
library(BioGeoBEARS)
wd = "/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj+BD_M0_mr3/"  # CHANGE THIS
setwd(wd)
...
pdffn = "phyBEARS_cicadidae2_DEC+J+BD_M0_unconstrained_v1.pdf"  # CHANGE THIS
