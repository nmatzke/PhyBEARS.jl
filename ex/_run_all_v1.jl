...
# cicadidae: Add extinction (inferred, or fixed to equal death rate)

cd("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DEC_M0_mr3/")
include("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DEC_M0_mr3/phybears_M0_mr3_DEC+Yule_v2.jl")

cd("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj_M0_mr3/")
include("/GitHub/PhyBEARS.jl/ex/cicadidae2/phybears_DECj_M0_mr3/phybears_M0_mr3_DEC+J+Yule_v2.jl")
...
# Note: In cicadidae3, we are adding sampling fractions
...
cd("/GitHub/PhyBEARS.jl/ex/cicadidae3/phybears_DECj+B=D_M0_mr3/")
include("/GitHub/PhyBEARS.jl/ex/cicadidae3/phybears_DECj+BD_M0_mr3/phybears_M0_mr3_DEC+J_BD_v2.jl")

cd("/GitHub/PhyBEARS.jl/ex/cicadidae3/phybears_DEC+B=D_M0_mr3/")
include("/GitHub/PhyBEARS.jl/ex/cicadidae3/phybears_DEC+B=D_M0_mr3/phybears_M0_mr3_DEC+B=D_v2.jl")
