...
"""
# Run with:
cd(expanduser("~/GitHub/PhyBEARS.jl/ex/cicadidae4/phybears_DEC+B=D_M0_mr3/"))
include(expanduser("~/GitHub/PhyBEARS.jl/ex/cicadidae4/phybears_DEC+B=D_M0_mr3/phybears_M0_mr3_DEC+B=D_v2.jl"))
"""

setwd(expanduser("~/GitHub/PhyBEARS.jl/ex/cicadidae4/phybears_DEC+B=D_M0_mr3/"))

# Input geography
lgdata_fn = expanduser("~/GitHub/PhyBEARS.jl/ex/cicadidae4/phybears_DEC+B=D_M0_mr3/geog.data")
geog_df = Parsers.getranges_from_LagrangePHYLIP(lgdata_fn)

# Input tree
trfn = expanduser("~/GitHub/PhyBEARS.jl/ex/cicadidae4/phybears_DEC+B=D_M0_mr3/tree.newick")
...
pdffn = "phyBEARS_cicadidae4_DEC+Birth=Death_M0_unconstrained_v1.pdf"  # CHANGE THIS
pdf(pdffn, height=24, width=9)
analysis_titletxt ="PhyBEARS DEC+Birth=Death on Cicadidae M0_unconstrained"  # CHANGE THIS
results_object = res
