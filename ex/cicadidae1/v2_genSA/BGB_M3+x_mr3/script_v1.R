...
wd = "/GitHub/PhyBEARS.jl/ex/cicadidae1/v2_genSA/BGB_M3+x_mr3/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Cicadidae
# (from Mark Stukel)
# "trfn" = "tree file name"
trfn = "tree.newick"
...
pdffn = "tree.pdf"
pdf(file=pdffn, width=9, height=18)

tr = read.tree(trfn)
tr
plot(tr, cex=0.5)
title("Cicadidae phylogeny from Mark Stukel")
...
# This is the example geography file for Cicadidae
# (from Mark Stukel)
geogfn = "geog.data"
