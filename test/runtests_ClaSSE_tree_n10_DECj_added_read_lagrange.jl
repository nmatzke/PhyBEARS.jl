...
include("/GitHub/PhyBEARS.jl/test/runtests_ClaSSE_tree_n10_DECj.jl")
"""
# 
# """
# # Run with:
...
# 	@test hello("runtests_ClaSSE_tree_n10_DECj.jl") == "runtests_ClaSSE_tree_n10_DECj.jl"
# #	@test domath(2.0) ≈ 7.0
# end
# 
# 
...
# #######################################################
# 
@testset "runtests_ClaSSE_tree_n10_DECj.jl" begin
# 
#######################################################
...
numareas = length(areas_txt_list)
