...
# (406.404, 22, -6915.288991622957, -13.26458352192622, -6928.553575144883, -6220.667913328516)
# 
...
# failed, corrector convergence test
# 
...
include("/GitHub/PhyBEARS.jl/notes/remotecall_fetch_trial_v1.jl")
max_iterations=10^5; return_lnLs=true
@benchmark (total_calctime_in_sec, iteration_number, Julia_sum_lq, rootstates_lnL, Julia_total_lnLs1, bgb_lnL) = iterative_downpass_parallel_ClaSSE_v7e!(res; trdf=trdf, p_Ds_v7=p_Ds_v5, solver_options=inputs.solver_options, max_iterations=10^4.5, return_lnLs=true)
...
include("/GitHub/PhyBEARS.jl/notes/remotecall_fetch_trial_v1.jl")
(total_calctime_in_sec, iteration_number, Julia_sum_lq, rootstates_lnL, Julia_total_lnLs1, bgb_lnL) = iterative_downpass_parallel_ClaSSE_v7d!(res; trdf=trdf, p_Ds_v7=p_Ds_v5, solver_options=inputs.solver_options, max_iterations=10^6, return_lnLs=true)
