...
tvals = seq(0.0, maximum(trdf.node_age), 0.1);
#condnums = opnorm.(Gflow_to_01_GMRES.(tvals), 2)
#print("\ncondnums:\n")
#print(condnums)

print("\nrankss:\n")
ranknums = rank.(Gflow_to_01_GMRES.(tvals))
print(ranknums)

#tval_above_condnum = Gmaps.find_Gflow_increment_size(tvals, p_Ds_v5; max_condition_number=1e8)
#print(paste0(["\ntval_above_condnum=", tval_above_condnum, "\n"]))
...
Gseg_times = seq(0.0, root_age, 0.01);
pG = (n=n, p_Ds_v5=p_Ds_v5, A=A);
