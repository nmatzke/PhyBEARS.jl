#######################################################
#
# Example ClaSSE calculation
# result_EsDs_ClaSSE_1branch_pureBirth_bl1
# (1 branch, pure birth, no Q transitions, branchlength=1)
# 
#
# Run with:
#
# source("/GitHub/PhyBEARS.jl/test/ClaSSE_1branch_n2.R")
# 
#######################################################
...
#######################################################
#######################################################
# 5. ClaSSE likelihoods and comparison to yule
#######################################################
#######################################################
...
mu_vals = c(0.0, 0.0)
Qij_vals = c(0.0, 0.0)
Cijk_vals = c(0.2222222, 0.2222222)
...
out <- lsoda(y=y, times=times, func=define_ClaSSE_eqns_in_R, parms=parms) 
tail(out)
