...
include("/GitHub/PhyBEARS.jl/test/speedtests_Cyrtandra_wExtinction+J_branchTests_v1.jl")
"""
...
prob_Ds_v5 = DifferentialEquations.ODEProblem(BranchSpeeds.parameterized_ClaSSE_Ds_v5orig, p_Ds_v5.uE, Ds_tspan, p_Ds_v5);
...
solver_options.save_everystep = false
solver_options.saveat = node_ages
prob_Ds_v6 = DifferentialEquations.ODEProblem(BranchSpeeds.parameterized_ClaSSE_Ds_v6orig, p_Ds_v6.uE, Ds_tspan, p_Ds_v6);
...
@profile sol_Es_v5 = solve(prob_Es_v5, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol)
pprof(;webport=58699)
# http://localhost:58699"

@profile sol_Ds_v5 = solve(prob_Ds_v5, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=solver_options.saveat)
pprof(;webport=58700)
...
@profile sol_Es_v6 = solve(prob_Es_v6, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol)
pprof(;webport=58701)
# http://localhost:58701"

@profile sol_Ds_v6 = solve(prob_Ds_v6, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=solver_options.saveat)
pprof(;webport=58702)
# http://localhost:58702"


Es_saveats = seq(Es_tspan[1], Es_tspan[2], (Es_tspan[2]-Es_tspan[1]/100)) 

@benchmark sol_Es_v5 = solve(prob_Es_v5, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol)

@benchmark sol_Ds_v5 = solve(prob_Ds_v5, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=solver_options.saveat)



@benchmark sol_Es_v6 = solve(prob_Es_v6, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol)

@benchmark sol_Ds_v6 = solve(prob_Ds_v6, solver_options.solver, save_everystep=solver_options.save_everystep, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=solver_options.saveat)




@time sol_Es_v5 = solve(prob_Es_v5, solver_options.solver, save_everystep=false, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=Es_saveats);

@time sol_Ds_v5 = solve(prob_Ds_v5, solver_options.solver, save_everystep=false, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=solver_options.saveat);



@time sol_Es_v6 = solve(prob_Es_v6, solver_options.solver, save_everystep=false, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=Es_saveats);

@time sol_Ds_v6 = solve(prob_Ds_v6, solver_options.solver, save_everystep=false, 
abstol=solver_options.abstol, reltol=solver_options.reltol, saveat=solver_options.saveat);
...
solver_options.abstol = 1e-6;
solver_options.reltol = 1e-6;
solver_options.solver = QNDF()
res_nonFlow_v6par_QNDF = iterative_downpass_parallel_ClaSSE_v6!(res; trdf, p_Ds_v5=p_Ds_v5, solver_options=solver_options, max_iterations=10^10, return_lnLs=true);
(total_calctime_in_sec_nFv6par, iteration_number_nFv6par, Julia_sum_lq_nFv6par, rootstates_lnL_nFv6par, Julia_total_lnLs1_nFv6par, bgb_lnl_nFv6par) = res_nonFlow_v6par_QNDF

solver_options.abstol = 1e-6;
solver_options.reltol = 1e-6;
solver_options.solver = FBDF()
res_nonFlow_v6par_FBDF = iterative_downpass_parallel_ClaSSE_v6!(res; trdf, p_Ds_v5=p_Ds_v5, solver_options=solver_options, max_iterations=10^10, return_lnLs=true);
(total_calctime_in_sec_nFv6par, iteration_number_nFv6par, Julia_sum_lq_nFv6par, rootstates_lnL_nFv6par, Julia_total_lnLs1_nFv6par, bgb_lnl_nFv6par) = res_nonFlow_v6par_FBDF
