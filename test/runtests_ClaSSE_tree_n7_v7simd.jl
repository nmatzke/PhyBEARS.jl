...
# #######################################################
# 
@testset "runtests_ClaSSE_tree_n7_v7simd.jl -- 3 apes, DEC+largeJ+largeMu + simd Es" begin
# 
#######################################################
...
# Do downpass
res = inputs.res;
(total_calctime_in_sec, iteration_number, Julia_sum_lq, rootstates_lnL, Julia_total_lnLs1, bgb_lnL) = PhyBEARS.TreePass.iterative_downpass_nonparallel_ClaSSE_v5!(res; trdf=trdf, p_Ds_v5=p_Ds_v7, solver_options=inputs.solver_options, max_iterations=10^5, return_lnLs=true)
